...
%%% Essentials
\name{Cesar}{Aybar}
\address{\href{https://sourcerer.io/csaybar}{https://sourcerer.io/csaybar}}
\mobile{(+51) 95-2626-81} 
%%% Social
\email{csaybar@gmail.com}
\homepage{https://csaybar.github.io/}
\github{https://github.com/csaybar}
%%% Optionals
\position{Hydrology{\enskip\cdotp\enskip}Data Analytics}
